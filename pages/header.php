            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="single-product.html">Карточка товара</a></li>
                  <li class="nav-item"><a class="nav-link" href="checkout.html">Оплата товара</a></li>
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav-item"><a class="nav-link" href="tracking-order.html">Отслежвание</a></li>
                </ul>
              </li>
